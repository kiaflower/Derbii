    ...
    <div className="min-h-screen bg-stone-900 flex items-center justify-center px-6" style={{ fontFamily: 'Jost, sans-serif' }}>
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="block text-[10px] tracking-[0.2em] uppercase text-stone-500 mb-2">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-[10px] tracking-[0.2em] uppercase text-stone-500 mb-2">Mot de passe</label>
